...
# ------------------ REACTION SIMULATIONS ------------------
    ...
    reactions = {
        "Substitution": {
            ...
            "before": "https://www.chemistrysteps.com/wp-content/uploads/2020/06/Free-radical-halogenation-of-alkanes.png",
            "after": "https://www.chemistrysteps.com/wp-content/uploads/2020/06/halogenation-complete.png"
        },
        "Addition": {
            "desc": "Atoms are added to a molecule across a double/triple bond.",
            "before": "https://www.chemistrysteps.com/wp-content/uploads/2020/06/Additon-of-HBr-to-alkene.png",
            "after": "https://www.chemistrysteps.com/wp-content/uploads/2020/06/HBr-alkene-addition-result.png"
        },
        "Esterification": {
            "desc": "Acid + Alcohol forms an Ester and Water.",
            "before": "https://www.chemistrysteps.com/wp-content/uploads/2020/07/Esterification-Reaction.png",
            "after": "https://www.chemistrysteps.com/wp-content/uploads/2020/07/Esterification-complete.png"
        }
    }
    ...
    for name, data in reactions.items():
        with st.expander(name):
            ...
            st.image(data['before'], caption="Before Reaction", use_column_width=True)
            st.image(data['after'], caption="After Reaction", use_column_width=True)
